...
CSV_PREDICTIONS = BASE_DIR + "/uploads/menu.csv"
TRAIN_DATA = BASE_DIR + "/data/data_prediction.csv"
...
grid_search = GridSearchCV(
    pipeline, param_grid, cv=3, scoring="neg_mean_squared_error", verbose=1, n_jobs=-1
)
